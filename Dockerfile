...
RUN curl -SLO "https://github.com/just-containers/s6-overlay/releases/download/v3.2.0.2/s6-overlay-${ARCH}.tar.gz" \
...
RUN set -x \
  ...
  && curl -SLo ${GUACAMOLE_HOME}/lib/postgresql-42.7.5.jar "https://jdbc.postgresql.org/download/postgresql-42.7.5.jar" \
